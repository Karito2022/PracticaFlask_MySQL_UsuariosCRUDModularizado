...
class MySQLConnection:
    def __init__(self, db):
        # cambie el usuario y la contraseña según sea necesario
        ...
        with self.connection.cursor() as cursor:
            try:
                ...
                if query.lower().find("insert") >= 0:
                    ...
                    # Las consultas SELECCIONAR devolverán los datos de la base de datos como una LISTA DE DICCIONARIOS
                ...
                # si la consulta falla, el método devolverá FALSO
